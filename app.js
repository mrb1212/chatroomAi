...
app.post("/github-webhook", (req, res) => {
    ...
    if (branch === "production") {
        ...
        execSync("cd /www/wwwroot/chat.keytex.ir && git reset --hard origin/production && git pull origin production && npm install --production=false && npm run build && systemctl restart chatKeytex", (error, stdout, stderr) => {
            if (error) {
